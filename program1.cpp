...
//	Airport * Adelaide = new Airport (6, 2, "Adelaide Airport", "South Australia" );
	...
	return 0;
		...
		cout<<"					Select plane."<<endl<<" _______________________________________________________________________________________________________ "<<endl;
		cout<<"|				Please enter the informations:						|"<<endl<<"|_______________________________________________________________________________________________________|"<<endl;
		...
		plane[SelectPlane]->get_destination(destination, from);
		plane[SelectPlane]->get_pilot(pilot, copilot);
		plane[SelectPlane]->passenger(passenger);
		...
		cout<<"				The plane is "<<plane[SelectPlane]->destination<< " is added into the system."<<endl;
		cout<<"				The pilot is "<<plane[SelectPlane]->pilot<< " is added into the system."<<endl;
		cout<<"				The plane is "<<plane[SelectPlane]->passenger<< " is added into the system."<<endl;
		cout<<"					To continue enter any keys."<<endl;
		cin>>empty;
